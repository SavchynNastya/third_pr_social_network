        ...
        items: [
            ...
            activeIcon: ShaderMask(
              shaderCallback: (Rect bounds) {
                return LinearGradient(
                  ...
                  colors: [Color.fromARGB(255, 149, 56, 206), Colors.orange.shade600],
                  tileMode: TileMode.repeated,
                ).createShader(bounds);
              },
              child: Icon(Icons.home, color: Color.fromARGB(255, 255, 255, 255),),
            ),
          ...
          BottomNavigationBarItem(
            ...
            activeIcon: ShaderMask(
              ...
              child: Icon(Icons.search, color: Color.fromARGB(255, 255, 255, 255),),
            ),
          ...
          BottomNavigationBarItem(
            ...
            icon: new Icon(Icons.add, color: Colors.grey),
          ),
          BottomNavigationBarItem(
            label: 'feed',
            activeIcon: ShaderMask(
              ...
              child: Icon(Icons.video_collection_outlined, color: Color.fromARGB(255, 255, 255, 255),),
            ),
            icon: new Icon(Icons.video_collection_outlined, color: Colors.grey),
          ),
          BottomNavigationBarItem(
            label: 'feed',
            activeIcon: ShaderMask(
